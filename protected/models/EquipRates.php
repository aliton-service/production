...
/**
 * This is the model class for table "EquipRates".
 *
 * The followings are the available columns in table 'EquipRates':
 ...
 */
class EquipRates extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('eqrt_id, date_start, date_end, Lock, EmplLock, DateLock, EmplCreate, DateCreate, EmplChange, DateChange, EmplDel, DelDate', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return EquipRates the static model class
	 */
	 public function deleteCount($id, $empl_id) {
	 
		$Command = Yii::app()->db->createCommand(''
                . "UPDATE EquipRates SET EmplDel = {$empl_id}, DelDate = '".date('m.d.y H:i:s')."' WHERE eqrt_id = {$id}
                ");
