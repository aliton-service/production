<script>
    ...
    $(document).ready(function(){
        if (Ajax == '') {
            ...
            $("#EmplCreate").jqxComboBox($.extend(true, {}, ComboBoxDefaultSettings, { source: DataEmpl, displayMember: "ShortName", valueMember: "Employee_id", width: 200 }));
...
<div class="row" style="margin-left: 20px;">
    ...
    <div class="row">
        <div class="row-column">Зарег.: </div>
        <div class="row-column"><div id='EmplCreate' name="Parameters[prmEmplCreate]"></div></div>
    </div>
