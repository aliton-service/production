...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ComplexityName'); ?>
		<?php echo $form->textField($model,'ComplexityName',array('class'=>'form-control','size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'ComplexityName'); ?>
	</div>
