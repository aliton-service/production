...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'SystemTypeName'); ?>
		<?php echo $form->textField($model,'SystemTypeName',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'SystemTypeName'); ?>
	</div>
