...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'ServiceType_id'); ?>
		<?php echo $form->textField($model,'ServiceType_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'ServiceType'); ?>
		<?php echo $form->textField($model,'ServiceType',array('size'=>50,'maxlength'=>50)); ?>
	</div>
