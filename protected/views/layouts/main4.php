                    ...
                    $this->widget('zii.widgets.CMenu',array(
                        ...
                        'items'=>array(
                            ...
                            array('label'=>'Справочники', 'visible'=>!Yii::app()->user->isGuest, 'url'=>array('/reference/index'),
                                'items' => array(
                                    array('label'=>'Объекты', 'url'=>'#', 'items'=>array(
                                        ...
                                        array('label'=>'Наценки по объектам', 'url'=>array('/AreaPrices/index'), 'visible'=>Yii::app()->user->checkAccess('ViewAreaPrices')),
                                        array('label'=>'Наценки по объектам 2', 'url'=>array('/AreaObjectPrices/index'), 'visible'=>Yii::app()->user->checkAccess('ViewAreaObjectPrices')),
                            ...
                            array('label'=>'Склад', 'url'=>'#', 'visible'=>Yii::app()->user->checkAccess('WHDocumentsView'), 'items'=>array(
                                ...
                                array('label'=>'Контроль возвратов', 'url'=>array('/ControlWHDocuments/index'), 'visible'=>Yii::app()->user->checkAccess('ViewControlWHDocuments')),
                            ...
                            array('label'=>'Отчеты', 'url'=>'#', 'items' => array(
                                ...
                                array('label'=>'Склад', 'url'=>'#', 'visible'=>Yii::app()->user->checkAccess('WHDocumentsReportAll'), 'items'=>array(
                                    ...
                                    array('label' => 'Расход товара за период',
                                ...
                                array('label'=>'Списание оборудования', 'url'=>'#', 'visible'=>Yii::app()->user->checkAccess('WHActsAll'), 'items'=>array(
                                    array('label' => 'Отчет по списанию (детальный)',
                                        'url' => Yii::app()->createUrl('Reports/ReportOpen', array('ReportName' => '/Списание оборудования/Списание оборудования (детальный)', 'Render' => 0)),
                                        'visible'=>Yii::app()->user->checkAccess('WHActs1Report')
                                    ),
                                    array('label' => 'Отчет по списанию (суммарный)',
                                        'url' => Yii::app()->createUrl('Reports/ReportOpen', array('ReportName' => '/Списание оборудования/Списание оборудования (суммарный)', 'Render' => 0)),
                                        'visible'=>Yii::app()->user->checkAccess('WHActs2Report')
                                    ),
                                    array('label' => 'Оборудование числящееся за мастерами',
                            ...
                            array('label'=>'Дизайн', 'url'=>array('/site/design')),
