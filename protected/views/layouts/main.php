...
<body>
    ...
    <header id="page-header">
        ...
        <div class="page-header__user-name">
            <div class="user-name">Хлебников Иван Александрович</div>
            <div class="user-position">бухгалтер</div>
        </div>
        <div class="page-header__logout"></div>
    ...
    //                            array('label'=>'Выход ('.$fullname.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
            ...
            <div class="page-content__filters">
                <?php if (isset($this->filters))
                    $this->renderPartial($this->filters, null, false, true);
                ?>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".menu-btn").on("click", function () {
                $(".page-content__menu").toggle(100, function(){});
            });
