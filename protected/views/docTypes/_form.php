...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'DocType_Name'); ?>
		<?php echo $form->textField($model,'DocType_Name',array('class'=>'form-control','size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'DocType_Name'); ?>
	</div>
