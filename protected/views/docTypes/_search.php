...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'DocType_Id'); ?>
		<?php echo $form->textField($model,'DocType_Id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'DocType_Name'); ?>
		<?php echo $form->textField($model,'DocType_Name',array('size'=>50,'maxlength'=>50)); ?>
	</div>
