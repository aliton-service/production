...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'eqct_name'); ?>
		<?php echo $form->textField($model,'eqct_name',array('class'=>'form-control','size'=>60,'maxlength'=>80)); ?>
		<?php echo $form->error($model,'eqct_name'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'eqct_price'); ?>
		<?php echo $form->textField($model,'eqct_price',array('class'=>'form-control','size'=>19,'maxlength'=>19)); ?>
		<?php echo $form->error($model,'eqct_price'); ?>
	</div>
<!-- 
	<div class="row">
