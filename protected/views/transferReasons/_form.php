...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'TransferReason'); ?>
		<?php echo $form->textField($model,'TransferReason',array('class'=>'form-control','size'=>60,'maxlength'=>150)); ?>
		<?php echo $form->error($model,'TransferReason'); ?>
	</div>
<!-- 
	<div class="row">
