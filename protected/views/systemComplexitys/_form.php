...
?>
    ...
    <div class="row" style="width: 300px;">Коэффициент: <div id='Coefficient' name="SystemComplexitys[Coefficient]"  class="row-column"></div><?php echo $form->error($model, 'Coefficient'); ?></div>
    <br/>
