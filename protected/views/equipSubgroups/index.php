...
$this->menu=array(
	...
	array('label'=>'Редактировать EquipSubgroups', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'update')),
	array('label'=>'Удалить EquipSubgroups', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'delete')),
);
...
<h1>Редактирование Equip Subgroups</h1>
...
<script type="text/javascript">
	...
	$('body').on('click','li[data-action=delete] a',function(){
		$.ajax({
			type: 'post',
			url: $(this).attr('href'),
			data: 'EquipSubgroups=EquipSubgroups',
			success: function() {
