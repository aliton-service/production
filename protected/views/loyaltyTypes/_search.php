...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'LoyaltyType_Id'); ?>
		<?php echo $form->textField($model,'LoyaltyType_Id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'LoyaltyTypeName'); ?>
		<?php echo $form->textField($model,'LoyaltyTypeName',array('size'=>60,'maxlength'=>100)); ?>
	</div>
