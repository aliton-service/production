...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'LoyaltyTypeName'); ?>
		<?php echo $form->textField($model,'LoyaltyTypeName',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'LoyaltyTypeName'); ?>
	</div>
