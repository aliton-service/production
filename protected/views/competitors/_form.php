...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Competitor',array('class'=>'form-control','size'=>60,'maxlength'=>250)); ?>
		<?php echo $form->error($model,'Competitor'); ?>
	</div>
<!-- 
	<div class="row">
	...
	<div class="row">
		<?php echo $form->labelEx($model,'DelData'); ?>
		<?php echo $form->textField($model,'DelData'); ?>
		<?php echo $form->error($model,'DelData'); ?>
	</div>
 -->
