<script type="text/javascript">
    $(document).ready(function(){
        ...
        var StateInsert = <?php echo json_encode((Yii::app()->controller->action->id == 'Create')); ?>;
...
<?php if ((Yii::app()->user->checkAccess('LogDeliveryDemands')) && (Yii::app()->controller->action->id != 'Create')) {?>
...
<div class="row">
    <div class="row-column"><input type="button" value="Сохранить" id='btnSaveDelivery'/></div>
    <div class="row-column" style="float: right;"><input type="button" value="Отмена" id='btnCancelDelivery'/></div>
</div>
