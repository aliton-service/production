...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'JobType_Name'); ?>
		<?php echo $form->textField($model,'JobType_Name',array('class'=>'form-control','size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'JobType_Name'); ?>
	</div>
<!-- 
	<div class="row">
