...
//        var EmplRecords  = DataEmployees.records;
        ...
        $("#edDateEdit").jqxDateTimeInput($.extend(true, {}, DateTimeDefaultSettings, { width: '110px', value: WHDocuments.Date, formatString: 'dd.MM.yyyy'}));
        $("#edWorkTypeEdit").jqxComboBox({ source: DataWorkTypes, width: '200', height: '25px', displayMember: "name", valueMember: "wrtp_id"});
        $("#edStorageEdit").jqxComboBox({ source: DataStorages, width: '150', height: '25px', displayMember: "storage", valueMember: "storage_id", autoDropDownHeight: true});
        $("#edPriorEdit").jqxComboBox({ source: DataPrior, width: '130', height: '25px', displayMember: "DemandPrior", valueMember: "DemandPrior_id", autoDropDownHeight: true});
        ...
        $("#edDeadlineEdit").jqxDateTimeInput($.extend(true, {}, DateTimeDefaultSettings, { width: '130px', value: WHDocuments.Deadline, formatString: 'dd.MM.yyyy', dropDownHorizontalAlignment: 'right'}));
        $("#edAddressEdit").jqxInput($.extend(true, {}, InputDefaultSettings, {width: 600} ));
        $('#edNoteEdit').jqxTextArea({ disabled: false, placeHolder: '', height: 50, width: '99.5%', minLength: 1});
        $("#edReceiptReasonEdit").jqxComboBox({ source: DataReceiptReasons, width: '270', height: '25px', displayMember: "name", valueMember: "rcrs_id"});
...
<input type="hidden" name="WHDocuments[dmnd_id]" value="<?php echo $model->dmnd_id; ?>" />
