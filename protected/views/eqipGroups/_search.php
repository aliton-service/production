...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'parent_group_id'); ?>
		<?php echo $form->textField($model,'parent_group_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'full_group_name'); ?>
		<?php echo $form->textField($model,'full_group_name',array('size'=>-1,'maxlength'=>-1)); ?>
	</div>
