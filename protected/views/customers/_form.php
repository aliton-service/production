...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'CustomerName',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'CustomerName'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'Reduction'); ?>
		<?php echo $form->textField($model,'Reduction',array('class'=>'form-control','size'=>10,'maxlength'=>10)); ?>
