...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'ConfirmCancel_id'); ?>
		<?php echo $form->textField($model,'ConfirmCancel_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'ConfirmCancelName'); ?>
		<?php echo $form->textField($model,'ConfirmCancelName',array('size'=>50,'maxlength'=>50)); ?>
	</div>
