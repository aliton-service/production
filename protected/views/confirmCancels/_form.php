...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ConfirmCancelName'); ?>
		<?php echo $form->textField($model,'ConfirmCancelName',array('class'=>'form-control','size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'ConfirmCancelName'); ?>
	</div>
