...
$this->menu=array(
	...
	array('label'=>'Редактировать Подтверждение отмены накладной', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'update')),
	array('label'=>'Удалить Подтверждение отмены накладной', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'delete')),
);
...
<h1>Редактирование Подтверждение отмены накладной</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		// 'ConfirmCancel_id',
		'ConfirmCancelName'=>array('name'=>'ConfirmCancelName', 'header'=>'Название подтверждения отмены накладной'),
		// 'Lock',
		// 'EmplLock',
		// 'DateLock',
		// 'EmplChange',
...
<script type="text/javascript">
	...
	$('body').on('click','li[data-action=delete] a',function(){
		$.ajax({
			type: 'post',
			url: $(this).attr('href'),
			data: 'ConfirmCancels=ConfirmCancels',
			success: function() {
