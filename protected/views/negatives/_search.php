...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'ngtv_id'); ?>
		<?php echo $form->textField($model,'ngtv_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'NegativeName'); ?>
		<?php echo $form->textField($model,'NegativeName',array('size'=>50,'maxlength'=>50)); ?>
	</div>
