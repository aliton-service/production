...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'NegativeName'); ?>
		<?php echo $form->textField($model,'NegativeName',array('class'=>'form-control','size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'NegativeName'); ?>
	</div>
<!-- 
	<div class="row">
