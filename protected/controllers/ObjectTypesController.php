...
class ObjectTypesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ObjectTypes']))
		{
			$model->attributes=$_POST['ObjectTypes'];
			$model->DateCreate = date('m.d.y H:i:s');
			$model->DateChange = date('m.d.y H:i:s');
			if($model->save())
				$this->redirect(array('view','id'=>$model->ObjectType_Id));
		}
	...
	$model=new ObjectTypes;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('ObjectTypes', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=new ObjectTypes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ObjectTypes']))
			$model->attributes=$_GET['ObjectTypes'];
	 ...
	 * @param ObjectTypes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='object-types-form')
		{
