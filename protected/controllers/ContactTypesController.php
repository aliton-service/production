...
class ContactTypesController extends Controller
{
	...
	$model=new ContactTypes;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('ContactTypes', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=ContactTypes::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ContactTypes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='contact-types-form')
		{
