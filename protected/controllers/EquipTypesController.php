...
class EquipTypesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EquipTypes']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->EquipType_id));
		}
	...
	$model=new EquipTypes;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('EquipTypes', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=new EquipTypes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EquipTypes']))
			$model->attributes=$_GET['EquipTypes'];
	 ...
	 * @return EquipTypes the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipTypes::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipTypes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equip-types-form')
		{
