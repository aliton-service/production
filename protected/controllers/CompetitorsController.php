...
class CompetitorsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Competitors']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->cmtr_id));
		}
	...
	$model=new Competitors;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('Competitors', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=Competitors::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Competitors $model the model to be validated
	 */
