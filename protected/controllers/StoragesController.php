...
class StoragesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Storages']))
		{
			$model->attributes=$_POST['Storages'];
	...
	$model=new Storages;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('Storages', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=new Storages('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Storages']))
			$model->attributes=$_GET['Storages'];
	 ...
	 * @return Storages the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Storages::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Storages $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='storages-form')
		{
