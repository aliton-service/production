...
class MalfunctionsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Malfunctions']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->Malfunction_id));
		}
	...
	$model=new Malfunctions;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('Malfunctions', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=new Malfunctions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Malfunctions']))
			$model->attributes=$_GET['Malfunctions'];
	 ...
	 * @return Malfunctions the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Malfunctions::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Malfunctions $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='malfunctions-form')
		{
