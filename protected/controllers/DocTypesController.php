...
class DocTypesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['DocTypes']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->DocType_Id));
		}
	...
	$model=new DocTypes;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('DocTypes', $model->tableSchema->primaryKey, $id))
	...
	{
		$model=DocTypes::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DocTypes $model the model to be validated
	 */
