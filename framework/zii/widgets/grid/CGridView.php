...
class CGridView extends CBaseListView
{
	...
	public $enableHistory=false;
        ...
        public $tableWidth='1024px';
        public $tableHeight='500px';
	/**
	...
	public function renderItems()
	{
		...
		{
			if ($this->tableHeight == '')
                            echo "<div class='items_table' style= 'width:".$this->tableWidth."'>";
                        else
                            echo "<div class='items_table' style= 'width:".$this->tableWidth."; height:".$this->tableHeight."'>";
