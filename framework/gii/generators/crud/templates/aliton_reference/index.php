...
$this->menu=array(
	...
	array('label'=>'Редактировать <?php echo $this->modelClass; ?>', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'update')),
	array('label'=>'Удалить <?php echo $this->modelClass; ?>', 'url'=>array('#'), 'itemOptions'=>array('data-action'=>'delete')),
);
...
<script type="text/javascript">
	...
	$('body').on('click','li[data-action=delete] a',function(){
		$.ajax({
			type: 'post',
			url: $(this).attr('href'),
			data: '<?php echo $this->modelClass; ?>=<?php echo $this->modelClass; ?>',
			success: function() {
