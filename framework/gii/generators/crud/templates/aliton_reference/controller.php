...
class <?php echo $this->controllerClass; ?> extends <?php echo $this->baseControllerClass."\n"; ?>
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'roles'=>array(
					'View<?php echo $this->modelClass; ?>',
					'Create<?php echo $this->modelClass; ?>',
					'Update<?php echo $this->modelClass; ?>',
			...
			/* array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin'),
				'roles'=>array(
					'Admin<?php echo $this->modelClass; ?>',
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				...
				'roles'=>array(
					...
					'Delete<?php echo $this->modelClass; ?>',
	...
	$model=new <?php echo $this->modelClass; ?>;
		 if ($id == null)
                ...
                if (!Yii::app()->LockManager->LockRecord('<?php echo $this->modelClass; ?>', $model->tableSchema->primaryKey, $id))
